...
object TaxiAnalysis extends App{
  ...
  .format("parquet")
  .option("header", true) 
  .option("path", "hdfs:///Projects/Dataset/Taxi/yellow_taxi_trip_records/2022/yellow*.parquet")
  .load()
  ...
  .format("csv")
  .option("header", true) 
  .option("path", "hdfs:///Projects/Dataset/Taxi/yellow_taxi_trip_records/taxi_zone_lookup.csv")
  .load()
